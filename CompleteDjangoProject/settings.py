"""
Django settings for CompleteDjangoProject project.
...
SECRET_KEY = '*+$z$xrwqzl+n=fa6pii)bzvh9(wml(@_eevc^upvu51vv@h4%'
...
ROOT_URLCONF = 'CompleteDjangoProject.urls'
...
WSGI_APPLICATION = 'CompleteDjangoProject.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'formulabdformulabdformulabd@123'
